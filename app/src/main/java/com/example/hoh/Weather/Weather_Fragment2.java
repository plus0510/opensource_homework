...
public class Weather_Fragment2 extends Fragment {
    ...
    Weather_Fragment2.MyAdapter adapter;
    ...
    public static Weather_Fragment2 newInstance(int page, String title) {
        Weather_Fragment2 fragment = new Weather_Fragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new Weather_Fragment2.MyAdapter(list);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this.getActivity());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.addItemDecoration(new Weather_Fragment2.MyItemDecoration());
        ...
        StringRequest forecastRequest = new StringRequest(Request.Method.POST, "https://api.openweathermap.org/data/2.5/forecast?q=cheonan&mode=xml&units=metric&appid=e959d55cc582f00055d5f278f469623b", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    private class MyAdapter extends RecyclerView.Adapter<Weather_Fragment2.MyViewHolder> {
        private final List<Weather_Fragment2.ItemData> list;

        public MyAdapter(List<Weather_Fragment2.ItemData> list) {
            this.list = list;
        }

        @Override
        public Weather_Fragment2.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.weather_item, parent, false);
            return new Weather_Fragment2.MyViewHolder(view);
        }

        @Override
        public void onBindViewHolder(Weather_Fragment2.MyViewHolder holder, int position) {
            Weather_Fragment2.ItemData vo = list.get(position);
    ...
    private void parseXMLForecast(String response) {
        try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                final Weather_Fragment2.ItemData vo = new Weather_Fragment2.ItemData();
