...
public class Weather_Fragment1 extends Fragment {
    ...
    Weather_Fragment1.MyAdapter adapter;
    ...
    public static Weather_Fragment1 newInstance(int page, String title) {
        Weather_Fragment1 fragment = new Weather_Fragment1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new Weather_Fragment1.MyAdapter(list);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this.getActivity());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.addItemDecoration(new Weather_Fragment1.MyItemDecoration());
        ...
        StringRequest forecastRequest = new StringRequest(Request.Method.POST, "https://api.openweathermap.org/data/2.5/forecast?q=asan&mode=xml&units=metric&appid=e959d55cc582f00055d5f278f469623b", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    private class MyAdapter extends RecyclerView.Adapter<Weather_Fragment1.MyViewHolder> {
        private final List<Weather_Fragment1.ItemData> list;

        public MyAdapter(List<Weather_Fragment1.ItemData> list) {
            this.list = list;
        }

        @Override
        public Weather_Fragment1.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.weather_item, parent, false);
            return new Weather_Fragment1.MyViewHolder(view);
        }

        @Override
        public void onBindViewHolder(Weather_Fragment1.MyViewHolder holder, int position) {
            Weather_Fragment1.ItemData vo = list.get(position);
    ...
    private void parseXMLForecast(String response) {
        try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                final Weather_Fragment1.ItemData vo = new Weather_Fragment1.ItemData();
